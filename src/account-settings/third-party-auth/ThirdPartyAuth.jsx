...
class ThirdPartyAuth extends Component {
                ...
                {hasError ? (
                    <Alert className="alert-danger">
                        <FormattedMessage
                            ...
                            defaultMessage="Đã xảy ra sự cố khi ngắt kết nối tài khoản này. Liên hệ hỗ trợ nếu vấn đề vẫn tiếp diễn."
                    ...
                    labels={{
                        default: (
                            <FormattedMessage
                                ...
                                defaultMessage="Hủy liên kết tài khoản {name}"
    ...
    renderProvider({ name, disconnectUrl, connectUrl, connected, id }) {
        return (
    ...
    renderNoProviders() {
        return (
            <FormattedMessage
                ...
                defaultMessage="Không thể liên kết tài khoản nào vào lúc này."
