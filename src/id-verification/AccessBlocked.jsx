    ...
    const handleMessage = () => {
        ...
        return (
            <FormattedMessage
                ...
                defaultMessage="Chúng tôi không thể xác minh danh tính của bạn vào lúc này. Nếu bạn chưa kích hoạt tài khoản của mình, vui lòng kiểm tra thư mục spam để tìm email kích hoạt từ {email}."
